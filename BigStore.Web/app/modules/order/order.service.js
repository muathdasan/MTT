...
var orderService = /** @class */ (function () {
    function orderService(_http) {
        this._http = _http;
        this._categoryUrl = 'api/order';
    }
    orderService.prototype.getorders = function (page, pageSize) {
    ...
    orderService.prototype.getallordersnotCompleted = function (page, pageSize) {
        var RequestOpt = new http_1.RequestOptions();
        var Parameter = new http_1.URLSearchParams();
        if (page) {
            Parameter.set("page", page.toString());
    ...
    orderService.prototype.getrecentorders = function () {
