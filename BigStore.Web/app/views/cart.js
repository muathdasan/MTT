...
var Cart = /** @class */ (function () {
    ...
    Cart.prototype.clickOnProductRemove = function (id) {
        var index = this.products.findIndex(function (i) { return i.Id = id; });
        if (index !== -1) {
    ...
    Cart.prototype.clickOnClose = function () {
        this.onClose.emit();
    };
